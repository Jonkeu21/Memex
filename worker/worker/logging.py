...
Adapted from capture_api/app/logging.py per Phase 2 tracker note: until the
shared package is extracted, each service keeps a local copy. The public
surface (configure, log_event, redact, hash_chat_id, JsonFormatter) matches.
"""
...
_BODY_KEYS = {"text", "body", "content", "raw", "extracted_text"}
